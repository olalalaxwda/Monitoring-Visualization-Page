...
export default function Index() {
  ...
  useEffect(() => {
    myChart = echarts.init(fpRef.current)
    ...
    getData("keyperformancedata").then((v) => {
      ...
      v.map((item) => {
        ...
        (xyLab[labKey] != undefined && (xyLab[labKey] += item.firstPaintTime * 1)) || (xyLab[labKey] == undefined && (xyLab[labKey] = item.firstPaintTime * 1))
      })
  ...
  return (
    <div className='fp' ref={fpRef}>FP fp</div>
  )
}
