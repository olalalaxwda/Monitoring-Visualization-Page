...
export default function Index() {
  ...
  useEffect(() => {
    myChart = echarts.init(fcpRef.current)
    ...
    getData("keyperformancedata").then((v) => {
      ...
      v.map((item) => {
        ...
        (xyLab[labKey] != undefined && (xyLab[labKey] += item.firstContentPaint * 1)) || (xyLab[labKey] == undefined && (xyLab[labKey] = item.firstContentPaint * 1))
      })
  ...
  return (
    <div className='fcp' ref={fcpRef}>FCP fcp</div>
  )
}
